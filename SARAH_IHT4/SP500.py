...
from data import load_sp500, build_group_idx, load_groups
...
dataset = load_sp500(download=False)
groups = load_groups(download=False)
lookup = build_group_idx(dataset, groups)
...
result_path = "./results/SP500_copy3.json"
...
plt.savefig("./plots/SP500_copy3.png", dpi=200, bbox_inches="tight")
plt.show()
...
plt.savefig("./plots/SP500_test_only_copy3.png", dpi=200, bbox_inches="tight")
plt.show()
