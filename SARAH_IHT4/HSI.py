...
from data import load_hsi, load_groups_hsi, build_group_idx_hsi
...
groups = load_groups_hsi(download=False)
lookup = build_group_idx_hsi(dataset, groups)
...
result_path = "./results/HSI_copy.json"
...
plt.savefig("./plots/HSI_copy.png", dpi=200, bbox_inches="tight")
plt.show()
...
plt.savefig("./plots/HSI_test_only_copy.png", dpi=200, bbox_inches="tight")
plt.show()
